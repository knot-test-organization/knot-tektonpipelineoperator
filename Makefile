...
# nttdata.com/tektonpipeline-bundle:$VERSION and nttdata.com/tektonpipeline-catalog:$VERSION.
IMAGE_TAG_BASE ?= nttdata.com/tektonpipeline
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.25.1/ansible-operator_$(OS)_$(ARCH) ;\
